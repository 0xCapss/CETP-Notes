...
![Tables of handles](assets/1-Windows%20internals-Handle%20properties.png)
#### Token
...
![Token](assets/2-Windows%20Internals%20-%20Tokens.png)
...
- Virtual memory pages by order:
	...
	- Modules
![Virtual memory](assets/3-Windows%20internals-%20Virtual%20memory.png)
