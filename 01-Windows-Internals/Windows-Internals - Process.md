...
![Tables of handles](1-Windows%20internals-Handle%20properties.png)
#### Token
...
![Token](2-Windows%20Internals%20-%20Tokens.png)
...
- Virtual memory pages by order:
	...
	- Modules
![Virtual memory](3-Windows%20internals-%20Virtual%20memory.png)
